...
print("g for m1 in dataset 2 =", popt1_2[0])
print("uncertainty g for m1 in dataset 2 = ", pcov1_2[0]**0.5)
...
print("g for m2 in dataset 2 =", popt2_2[0])
print("uncertainty g for m2 in dataset 2 = ", pcov2_2[0]**0.5)
...
print("g for m3 in dataset 2 =", popt3_2[0])
print("uncertainty g for m3 in dataset 2 = ", pcov3_2[0]**0.5)
...
print("g for m1 in dataset 1 =", popt1_1[0])
print("uncertainty g for m1 in dataset 1 = ", pcov1_1[0]**0.5)
...
print("g for m1 in dataset 3 =", popt1_3[0])
print("uncertainty g for m1 in dataset 3 = ", pcov1_3[0]**0.5)
...
print("g for m2 in dataset 3 =", popt2_3[0])
print("uncertainty g for m2 in dataset 3 = ", pcov2_3[0]**0.5)
...
time_m3_3 = [0, *m3_h1_3, *m3_h3_3, *m3_h3_3, *m3_h4_3, *m3_h5_3, *m3_h6_3, *m3_h7_3, *m3_h8_3, *m3_h9_3]
...
print("g for m3 in dataset 3 =", popt3_3[0])
print("uncertainty g for m3 in dataset 3 = ", pcov3_3[0]**0.5)
...
plt.plot(time_m1_3, x1_3, 'x')
plt.plot(time_m2_3, x2_3, 'x')
plt.plot(time_m3_3, x3_3, 'x')
...
plt.plot(x_line, get_g1_3(x_line, *popt1_3), "-k")
plt.plot(x_line, get_g2_3(x_line, *popt2_3), "-k")
plt.plot(x_line, get_g3_3(x_line, *popt3_3), "-k")


plt.xlabel("Time taken for ball to fall [s]")
plt.ylabel("Drop height of the ball [m]")

plt.legend(("m1 for data 1","m2 for data 1","m1 for data 2", "m2 for data 2", "m3 for data 2", "m1 for new data", "m2 for new data", "m3 for new data"))
plt.show()
